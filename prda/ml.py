...
def kmeans_spark(data: pd.DataFrame, k_: int, inertia: bool = False): 
    ...
    inertia : bool, optional
        Indicator of whether return `sum of squared distances to the nearest centroid for all points in the training dataset (equivalent to sklearn’s inertia.)`
        , by default False
    ...
    .setInputCols(data.columns.to_list())\
